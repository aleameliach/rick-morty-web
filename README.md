<h1>🧬🥒👽Rick & Morty Character Finder and Details👽🥒🧬</h1>
...
- `Footer.js`: component that renders the footer.
...
I'm a junior Front-End Developer so any feedback will be highly appreciated!
